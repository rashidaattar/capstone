...
public class OrderDetailActivity extends AppCompatActivity {
    ...
    private void populateData(Cursor c) {
        order_number.setText(c.getString(c.getColumnIndex(OrdersTable.ORDER_NUMBER)));
        order_amount.setText(c.getString(c.getColumnIndex(OrdersTable.ORDER_AMOUNT)));
        order_date.setText(c.getString(c.getColumnIndex(OrdersTable.ORDER_DATE)));
        delivery_date.setText(c.getString(c.getColumnIndex(OrdersTable.DELIVERY_DATE)));

        customer_name.setText(c.getString(c.getColumnIndex(PersonTable.PERSON_NAME)));
        cusomer_company.setText(c.getString(c.getColumnIndex(PersonTable.COMPANY_NAME)));
